...
import Scrolleft from "./scrollleft";
import Sliderright from "./scrolright";
...
Output: Deployed software accessible to end-users.'/> 
    ...
    <Scrolleft />
      <img className='tols'src={tools} alt='tools that we use'/>
    <Sliderright /> 
    ...
    <img src={last} className="last" alt='man coding'/>
    <Foot />
    </div>
  );
}
